...
<body>
  ...
  <div class="one">
    <div style="padding: 10px 100px;">
        <span class="left">
            <a class="text-black" href="./contact_us.html"><i class="fa fa-envelope"></i> Contact</a> |
            <a class="text-black" href="./contact_us.html"><i class="fa fa-headphones"></i> Support</a> |
            <a class="text-black" href="./login.html"><i class="fa fa-user"></i> Login</a>
        </span>
